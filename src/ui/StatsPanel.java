 ...
 */
public final class StatsPanel extends JPanel implements Themeable {
    ...
    public StatsPanel(HistoryService historyService, Consumer<String> onInfo) {
        ...
        top.setOpaque(false);
        top.add(refresh);
        hint = new JLabel("基于历史记录汇总（成功/失败/常见结果）");
    ...
    public void restyle() {
        ...
        area.setBackground(UiTheme.COLOR_CONSOLE_BG);
        area.setForeground(UiTheme.COLOR_CONSOLE_FG);
